...
const Hero = () => {
  return (
    <section className="relative bg-gradient-to-br from-red-50 via-white to-gray-50 pt-16 pb-20 overflow-hidden">
      {/* Background decoration */}
      <div className="absolute inset-0 bg-grid-pattern opacity-5"></div>
      <div className="absolute top-10 right-10 w-72 h-72 bg-gradient-to-r from-red-400 to-red-600 rounded-full mix-blend-multiply filter blur-xl opacity-20 animate-pulse"></div>
      <div className="absolute bottom-10 left-10 w-72 h-72 bg-gradient-to-r from-gray-400 to-gray-600 rounded-full mix-blend-multiply filter blur-xl opacity-20 animate-pulse"></div>
          ...
          <div className="space-y-8">
            <div className="space-y-4">
              ...
              <h1 className="text-4xl md:text-6xl font-bold text-gray-900 leading-tight">
                Excellence in 
                <span className="bg-gradient-to-r from-red-600 to-red-700 bg-clip-text text-transparent"> CBC Secondary</span> Education
              </h1>
            ...
            <div className="grid grid-cols-3 gap-6 pt-8">
              ...
              <div className="text-center">
                <div className="flex items-center justify-center w-12 h-12 bg-gray-100 rounded-xl mb-2 mx-auto">
          ...
          <div className="relative">
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="bg-white rounded-2xl shadow-lg p-6 transform rotate-2 hover:rotate-0 transition-transform duration-300">
                <div className="w-12 h-12 bg-gradient-to-r from-red-500 to-red-600 rounded-xl mb-4"></div>
              ...
              {/* Subject Card 4 */}
              <div className="bg-white rounded-2xl shadow-lg p-6 transform -rotate-1 hover:rotate-0 transition-transform duration-300">
                <div className="w-12 h-12 bg-gradient-to-r from-gray-500 to-gray-600 rounded-xl mb-4"></div>
